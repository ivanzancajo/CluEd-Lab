...
const BASE_MOVEMENT_CONNECTIONS: Record<string, readonly string[]> = {
  ...
  'centro-norte': ['pasillo-superior-central', 'centro-oeste'],
  ...
  'centro-sur': ['centro-oeste', 'pasillo-inferior-izquierdo', 'pasillo-inferior-central', 'pasillo-inferior-derecho'],
  ...
  'pasillo-inferior-derecho': ['pasillo-inferior-central', 'spawn-blanco', 'centro-sur'],
  'spawn-blanco': ['pasillo-inferior-derecho'],
  'pasillo-derecho-superior': ['spawn-amarillo', 'pasillo-superior-derecho'],
